...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (undefined && undefined.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === \"function\" ? Iterator : Object).prototype);\n    return g.next = verb(0), g[\"throw\"] = verb(1), g[\"return\"] = verb(2), typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (g && (g = 0, op[0] && (_ = 0)), _) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\nvar WeatherApi = /** @class */ (function () {\n    function WeatherApi() {\n        var _this = this;\n        this.getData = function (location) { return __awaiter(_this, void 0, void 0, function () {\n            var url, response, data;\n            return __generator(this, function (_a) {\n                switch (_a.label) {\n                    case 0:\n                        url = this._getWeatherAPIUrl(location);\n                        return [4 /*yield*/, fetch(url, { mode: 'cors' })];\n                    case 1:\n                        response = _a.sent();\n                        if (!response.ok) {\n                            throw new Error(\"Response status: \".concat(response.status));\n                        }\n                        return [4 /*yield*/, response.json()];\n                    case 2:\n                        data = _a.sent();\n                        return [2 /*return*/, data];\n                }\n            });\n        }); };\n    }\n    // Dates should be in yyyy-MM-dd format\n    WeatherApi.prototype._getWeatherAPIUrl = function (location, startDate, endDate) {\n        if (typeof startDate === 'undefined') {\n            return \"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/\".concat(location, \"/?key=\").concat(WeatherApi._API_KEY);\n        }\n        if (typeof endDate === 'undefined') {\n            return \"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/\".concat(location, \"/\").concat(startDate, \"/?key=\").concat(WeatherApi._API_KEY);\n        }\n        return \"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/\".concat(location, \"/\").concat(startDate, \"/\").concat(endDate, \"/?key=\").concat(WeatherApi._API_KEY);\n    };\n    WeatherApi._API_KEY = 'FYP8W4KJUXDR8R6L7F4G7CZQH';\n    return WeatherApi;\n}());\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WeatherApi);\n\n\n//# sourceURL=webpack://template-repo/./src/api/WeatherApi.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _view_Home__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/Home */ \"./src/view/Home.ts\");\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scss/main.scss */ \"./src/scss/main.scss\");\n\n\ndocument.addEventListener('DOMContentLoaded', function () {\n    var home = new _view_Home__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n    home.render();\n});\n\n\n//# sourceURL=webpack://template-repo/./src/index.ts?");
...
eval("module.exports = __webpack_require__.p + \"bf6782c10fed9ed6cf88.svg\";\n\n//# sourceURL=webpack://template-repo/./src/assets/images/gear-spinner.svg?");
